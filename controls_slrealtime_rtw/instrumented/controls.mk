...
PRODUCT = $(START_DIR)/controls_slrealtime_rtw/controls
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/controls_slrealtime_rtw -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2022b/980~1.3/SG_BLO~1/common/libsg -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2022b/980~1.3 -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2022b/980~1.3/SG_BLO~1/can/include -I$(START_DIR)/controls_slrealtime_rtw/instrumented
...
DEFINES_STANDARD = -DMODEL=controls -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/controls_slrealtime_rtw/can_datatype_ground.cpp $(START_DIR)/controls_slrealtime_rtw/controls.cpp $(START_DIR)/controls_slrealtime_rtw/controls_cal.cpp $(START_DIR)/controls_slrealtime_rtw/controls_data.cpp $(START_DIR)/controls_slrealtime_rtw/rtGetInf.cpp $(START_DIR)/controls_slrealtime_rtw/rtGetNaN.cpp $(START_DIR)/controls_slrealtime_rtw/rt_nonfinite.cpp $(START_DIR)/controls_slrealtime_rtw/slrealtime_datatype_ground.cpp $(START_DIR)/controls_slrealtime_rtw/rte_controls_parameters.cpp $(START_DIR)/controls_slrealtime_rtw/main.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2022b/9.8.0.3/sg_blocks/can/sg_CANLIN_OfA2_setup_s.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2022b/9.8.0.3/sg_blocks/can/sg_CAN_OfA2_read_s.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2022b/9.8.0.3/sg_blocks/can/sg_CAN_OfA2_write_s.cpp host_timer_x86.c slrealtime_code_profiling_utility_functions.cpp
...
OBJS = rt_matrx.o rt_printf.o can_datatype_ground.o controls.o controls_cal.o controls_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o slrealtime_datatype_ground.o rte_controls_parameters.o main.o sg_CANLIN_OfA2_setup_s.o sg_CAN_OfA2_read_s.o sg_CAN_OfA2_write_s.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
%.o : $(START_DIR)/controls_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/controls_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/controls_slrealtime_rtw/instrumented/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/controls_slrealtime_rtw/instrumented/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
can_datatype_ground.o : $(START_DIR)/controls_slrealtime_rtw/can_datatype_ground.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


controls.o : $(START_DIR)/controls_slrealtime_rtw/controls.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


controls_cal.o : $(START_DIR)/controls_slrealtime_rtw/controls_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


controls_data.o : $(START_DIR)/controls_slrealtime_rtw/controls_data.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/controls_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/controls_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/controls_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slrealtime_datatype_ground.o : $(START_DIR)/controls_slrealtime_rtw/slrealtime_datatype_ground.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rte_controls_parameters.o : $(START_DIR)/controls_slrealtime_rtw/rte_controls_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/controls_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
