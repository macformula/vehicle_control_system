...
PRODUCT_NAME              = controller_autogen
MAKEFILE                  = controller_autogen.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/LinF/DOCUME~1/MACFE/Controls/ECUCOM~1/VEHICL~1/VEHICL~1/src
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
CMD_FILE                  = controller_autogen.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/controller_autogen.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/controller_autogen_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
%.obj : $(START_DIR)/controller_autogen_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
...
controller_autogen.obj : $(START_DIR)/controller_autogen_ert_rtw/controller_autogen.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


controller_autogen_data.obj : $(START_DIR)/controller_autogen_ert_rtw/controller_autogen_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
