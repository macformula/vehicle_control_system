...
typedef struct {
  ...
  uint8_T temporalCounter_i1;          /* '<S4>/mi_left' */
} DW_mi_left;
...
typedef struct {
  ...
  real_T MI_InverterEn_o;              /* '<S4>/mi_left' */
  ...
  uint16_T temporalCounter_i1_a;       /* '<S2>/driver_interface' */
  uint16_T temporalCounter_i1_g;       /* '<S1>/bm_control' */
  uint16_T temporalCounter_i1_l;       /* '<S1>/battery_monitor' */
  uint8_T is_c3_controller_autogen;    /* '<S5>/vd_screenshot_check' */
  uint8_T is_active_c3_controller_autogen;/* '<S5>/vd_screenshot_check' */
  uint8_T is_c1_controller_autogen;    /* '<S26>/vd_tc' */
  uint8_T is_active_c1_controller_autogen;/* '<S26>/vd_tc' */
  uint8_T temporalCounter_i1_j;        /* '<S26>/vd_tc' */
  uint8_T is_c8_controller_autogen;    /* '<S3>/governer_stateflow' */
  ...
  uint8_T is_active_c8_controller_autogen;/* '<S3>/governer_stateflow' */
  uint8_T is_c2_controller_autogen;    /* '<S2>/driver_interface' */
  uint8_T is_DI_running;               /* '<S2>/driver_interface' */
  uint8_T is_Ready_to_drive;           /* '<S2>/driver_interface' */
  uint8_T is_active_c2_controller_autogen;/* '<S2>/driver_interface' */
  ...
  uint8_T is_StartupSuperstate_k;      /* '<S1>/battery_monitor' */
