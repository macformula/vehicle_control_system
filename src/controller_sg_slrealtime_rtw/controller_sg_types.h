...
#ifndef RTW_HEADER_controller_sg_types_h_
#define RTW_HEADER_controller_sg_types_h_
#include "rtwtypes.h"
...
typedef struct tag_RTM_controller_sg_T RT_MODEL_controller_sg_T;

#endif                                 /* RTW_HEADER_controller_sg_types_h_ */
